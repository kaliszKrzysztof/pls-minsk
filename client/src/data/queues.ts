...
export const queue1 = createQueue({
  number: 1,
  round: firstRound,
  date: parse('2020-10-02T22:00:00.000Z').toISOString(),
});
export const queue2 = createQueue({
  number: 2,
  round: firstRound,
  date: parse('2020-10-09T22:00:00.000Z').toISOString(),
});
export const queue3 = createQueue({
  number: 3,
  round: firstRound,
  date: parse('2020-10-23T22:00:00.000Z').toISOString(),
});
export const queue4 = createQueue({
  number: 4,
  round: firstRound,
  date: parse('2020-10-30T22:00:00.000Z').toISOString(),
});
export const queue5 = createQueue({
  number: 5,
  round: firstRound,
  date: parse('2020-11-13T22:00:00.000Z').toISOString(),
});
export const queue6 = createQueue({
  number: 6,
  round: firstRound,
  date: parse('2020-11-20T22:00:00.000Z').toISOString(),
});
export const queue7 = createQueue({
  number: 7,
  round: firstRound,
  date: parse('2020-11-27T22:00:00.000Z').toISOString(),
});
export const queue8 = createQueue({
  number: 8,
  round: firstRound,
  date: parse('2020-12-11T22:00:00.000Z').toISOString(),
});
export const queue9 = createQueue({
  number: 9,
  round: firstRound,
  date: parse('2020-12-18T22:00:00.000Z').toISOString(),
});
export const queue10 = createQueue({
  number: 10,
  round: firstRound,
  date: parse('2021-01-22T22:00:00.000Z').toISOString(),
});
export const queue11 = createQueue({
  number: 11,
  round: firstRound,
  date: parse('2021-01-29T22:00:00.000Z').toISOString(),
});
