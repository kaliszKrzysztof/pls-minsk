...
// queue4
export const q4m1 = createMatch({ host: ceglow, guest: pvu, hostScore: 3, guestScore: 0, queue: queue4 });
export const q4m2 = createMatch({
  host: blackteam,
  guest: afm,
  hostScore: 3,
  guestScore: 2,
...
export const q4m3 = createMatch({ host: brzoze, guest: goldenBoys, hostScore: 0, guestScore: 3, queue: queue4 });
export const q4m4 = createMatch({ host: halinow, guest: fenix, hostScore: 0, guestScore: 3, queue: queue4 });
export const q4m5 = createMatch({ host: kaluszyn, guest: watra, hostScore: 3, guestScore: 2, queue: queue4 });
...
export const q5m2 = createMatch({ host: watra, guest: ekonom, hostScore: 3, guestScore: 1, queue: queue5 });
export const q5m3 = createMatch({ host: fenix, guest: kaluszyn, hostScore: 0, guestScore: 3, queue: queue5 });
export const q5m4 = createMatch({ host: goldenBoys, guest: halinow, hostScore: 3, guestScore: 0, queue: queue5 });
export const q5m5 = createMatch({ host: afm, guest: brzoze, hostScore: 3, guestScore: 0, queue: queue5 });
export const q5m6 = createMatch({ host: ceglow, guest: blackteam, hostScore: 3, guestScore: 1, queue: queue5 });
// queue6
...
// queue7
export const q7m1 = createMatch({ host: watra, guest: pvu, hostScore: 3, guestScore: 0, queue: queue7 });
export const q7m2 = createMatch({ host: fenix, guest: fabos, hostScore: 0, guestScore: 3, queue: queue7 });
export const q7m3 = createMatch({ host: goldenBoys, guest: ekonom, hostScore: 0, guestScore: 3, queue: queue7 });
export const q7m4 = createMatch({ host: afm, guest: kaluszyn, hostScore: 0, guestScore: 3, queue: queue7 });
export const q7m5 = createMatch({ host: ceglow, guest: halinow, hostScore: 3, guestScore: 0, queue: queue7 });
export const q7m6 = createMatch({ host: blackteam, guest: brzoze, hostScore: 1, guestScore: 3, queue: queue7 });
// queue8
export const q8m1 = createMatch({ host: pvu, guest: brzoze, hostScore: 3, guestScore: 0, queue: queue8 });
export const q8m2 = createMatch({ host: halinow, guest: blackteam, hostScore: 0, guestScore: 3, queue: queue8 });
export const q8m3 = createMatch({ host: kaluszyn, guest: ceglow, hostScore: 3, guestScore: 1, queue: queue8 });
export const q8m4 = createMatch({ host: ekonom, guest: afm, hostScore: 3, guestScore: 1, queue: queue8 });
export const q8m5 = createMatch({ host: fabos, guest: goldenBoys, hostScore: 3, guestScore: 0, queue: queue8 });
export const q8m6 = createMatch({ host: watra, guest: fenix, hostScore: 3, guestScore: 1, queue: queue8 });
// queue9
export const q9m1 = createMatch({ host: fenix, guest: pvu, hostScore: 2, guestScore: 3, queue: queue9 });
export const q9m2 = createMatch({
  host: goldenBoys,
  guest: watra,
  hostScore: 0,
  guestScore: 3,
